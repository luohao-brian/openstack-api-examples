...
ID='e836b196-ff8f-4ea4-8f0a-5bdb1e83c76c'
SERVER_ID='123345'
...
curl -i -X POST ${HEC_IAM_ENDPOINT}/v3/auth/tokens -H 'content-type: application/json' -d "$AUTH_PARAMS" > /tmp/hec_auth_res && {
    ...
    curl -i -X DELETE https://ecs.cn-north-1.myhwclouds.com/v2/${PROJECT_ID}/servers/${SERVER_ID}/os-interface/${ID} -H "X-Auth-Token:${TOKEN}"
}
